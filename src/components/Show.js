      ...
      <main>
        <div className="columns">
          ...
          <div className="column is-half-desktop is-full-mobile">
            ...
            <h2 onClick={this.handleFavourite}><i id="star"  className={`${!this.state.favourite ? 'far' : 'fas'} fa-star`}></i>{`${!this.state.favourite ? ' Add to Favourites' : ' Added to Favourites!'}`}</h2>
          </div>
        </div>
      </main>
    );
